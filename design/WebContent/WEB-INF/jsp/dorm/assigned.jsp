...
<body>
    ...
    <ul class="placeul">
    <li><a href="#">宿舍管理</a></li>
    <li><a href="#">学生分配宿舍</a></li>
    </ul>
    </div>
    
    <div class="formbody">
    
    <div class="formtitle"><span>学生登记缴费</span></div>
    
    <ul class="forminfo">
    <form action="sys/student/assignedDorm" method="post" id="assignedForm" onsubmit="return isFull();">
    <li>
        <label>姓名</label>
    ...
    <li>
        <label>宿舍</label>
        <select name="student_dorm" id="student_dorm" class="dfinput ">
    ...
    <li><label>&nbsp;</label><input type="button" class="btn" id="testBtn" value="检测" /><input type="submit" class="btn" id="subBtn" value="确认分配" style="display: none;"/></li>
    </ul>
    </form>
    ...
    <script type="text/javascript">
	    ...
	    function isFull() {
	    	var student_dorm = $("#student_dorm").val();
	    	if(student_dorm==0){
                alert("请选择宿舍");
                return false;
            }
