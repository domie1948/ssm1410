...
<body>
    ...
    <ul class="forminfo">
    <form action="sys/student/charge" method="post" id="chargeForm">
	    <li>
	        <label>姓名</label>
	    ...
	    <li><label>&nbsp;</label><input type="button" class="btn" id="testBtn" value="检测" /><input type="submit" class="btn" id="subBtn" value="确认已缴费" style="display: none;" onclick="javaScript:alert('操作成功')"/></li>
    </form>
	</ul>
