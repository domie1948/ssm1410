    ...
    <body>
	    <div class="place">
	        ...
	        <ul class="placeul">
	            ...
	            <li><a href="javascript:void(0);">专业管理</a></li>
	        </ul>
	    </div>
	    ...
	    <div class="rightinfo">
	        ...
	        <tbody>
		        <c:forEach items="${majorList }" var="ml" >
			        <tr>
			            <td align="center">${ml.major_id }</td>
			            <td align="center">${ml.major_name }</td>
			            <td align="center">
			                <a href="sys/major/delete/${ml.major_id}" onClick="return confirm('确定删除?');">
			                    删除
			                </a>
			            </td>
			        </tr>
